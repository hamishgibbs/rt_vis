...
System.register("example", [], function (exports_1, context_1) {
    "use strict";
    var Animal;
...
System.register("example.test", ["example"], function (exports_2, context_2) {
    "use strict";
    var example_1;
    ...
    return {
        ...
        execute: function () {
            test('Animal travelling', function () {
                var anim = new example_1.Animal();
...
System.register("rt_vis", [], function (exports_3, context_3) {
    "use strict";
    var d3, rtVisInterface, rtVis;
    ...
    return {
        ...
        execute: function () {
            ...
            rtVisInterface = (function () {
                function rtVisInterface() {
                }
                return rtVisInterface;
            }());
            rtVis = (function (_super) {
